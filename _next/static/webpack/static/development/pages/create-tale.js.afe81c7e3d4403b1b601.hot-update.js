...
var CreateTaleFinish = function CreateTaleFinish(props) {
  ...
  return __jsx(_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    __self: this
  }, "Export Reactale"), "Use this option to Export this reactale", __jsx("h3", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96
    },
    ...
    __self: this
  }, "Export this Reactale"), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_5__["default"], {
    variant: "contained",
    color: "primary",
    className: "margin-right-15 margin-top-15",
    ...
    __self: this
  }, "Save in local"), __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_5__["default"], {
    variant: "contained",
    color: "primary",
...
/***/ "./components/page-modules/createTale/exportFeatureText.js":
/*!*****************************************************************!*\
  !*** ./components/page-modules/createTale/exportFeatureText.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (featureText = {
  exportTale: {
    features: ["Export Reactale as both Text and File", "Exported Reactale can be imported and worked on", "Can be shared easily with reviewers and collaborator", "Works offline (Internet not required)"]
  },
  saveLocal: {
    features: ["Will be saved in device memory", "Will not be available in other devices", "Great choice if you use this device only for writing Reactale", "Works offline (Internet not required)"]
  },
  saveOnline: {
    features: ["Will be saved online in your logged in account", "Availabe accross any device you login from", "Great choice if you work from multiple devices", "Internet is mandatory"]
  }
});
...
//# sourceMappingURL=create-tale.js.afe81c7e3d4403b1b601.hot-update.js.map