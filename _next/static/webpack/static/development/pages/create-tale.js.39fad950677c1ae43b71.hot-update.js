...
/* harmony import */ var _ExportTaleModal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ExportTaleModal */ "./components/page-modules/createTale/ExportTaleModal.js");
/* harmony import */ var _utils_urls__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../utils/urls */ "./utils/urls.js");
/* harmony import */ var _common_cards__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../common/cards */ "./components/common/cards/index.js");
/* harmony import */ var _exportFeatureText__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./exportFeatureText */ "./components/page-modules/createTale/exportFeatureText.js");
...
var CreateTaleFinish = function CreateTaleFinish(props) {
  ...
  var saveTaleOnline = function saveTaleOnline() {
    ...
    fetch(_utils_urls__WEBPACK_IMPORTED_MODULE_9__["URL_CREATE_TALE"], {
      method: "POST",
  ...
  return __jsx(_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    __self: this
  }, __jsx(_ExportTaleModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    __self: this
  }, __jsx(_common_cards__WEBPACK_IMPORTED_MODULE_10__["InfoCard"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 93
    },
    ...
    __self: this
  }, _exportFeatureText__WEBPACK_IMPORTED_MODULE_11__["default"].exportTale.features.map(function (t) {
    return __jsx("li", {
      key: t,
      __source: {
        fileName: _jsxFileName,
    ...
    __self: this
  }, "Export Reactale"))), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_5__["default"], {
    item: true,
    xs: 12,
    sm: 4,
    __source: {
    ...
    __self: this
  }, _exportFeatureText__WEBPACK_IMPORTED_MODULE_11__["default"].saveLocal.features.map(function (t) {
    return __jsx("li", {
      key: t,
      __source: {
        fileName: _jsxFileName,
    ...
    __self: this
  }, "Save Offline"))), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_5__["default"], {
    item: true,
    xs: 12,
    sm: 4,
    __source: {
    ...
    __self: this
  }, _exportFeatureText__WEBPACK_IMPORTED_MODULE_11__["default"].saveOnline.features.map(function (t) {
    return __jsx("li", {
      key: t,
      __source: {
        fileName: _jsxFileName,
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_7__["connect"])(mapStateToProps)(CreateTaleFinish));

/***/ })

})
//# sourceMappingURL=create-tale.js.39fad950677c1ae43b71.hot-update.js.map